...
dotnet publish "src/Authenticator.UI/Authenticator.UI.csproj" -c "Release" -o $publishFolderApp /p:DebugType=None -p:PublishSingleFile=true --self-contained false # -r "win-x64"
